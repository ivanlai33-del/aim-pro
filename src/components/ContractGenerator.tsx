                ...
                <div className="flex-1 w-full overflow-x-auto bg-slate-100 p-4 md:p-10 rounded-3xl border border-black/20 shadow-inner flex justify-center print:p-0 print:m-0 print:bg-white print:border-none print:shadow-none print:overflow-visible print:w-full print:max-w-none">
                    <div
                        ...
                        className={cn(
                            ...
                            contractStyle === 'od_mono' && "max-w-4xl p-16 font-sans bg-white text-black  print:border  print:p-8",
                            ...
                            contractStyle === 'od_terminal' && "max-w-4xl p-16 font-mono bg-slate-50 text-slate-800  print:p-8",
                    ...
                    >
                        ...
                        {['od_swiss', 'od_brutal', 'od_editorial', 'od_mono', 'od_receipt', 'od_architect', 'od_academic', 'od_gallery', 'od_terminal', 'od_neo_classic'].includes(contractStyle) ? (
                            <div className={cn(
                                ...
                                contractStyle === 'od_mono' && "border-b-[2px] border-white pb-6 ",
                                ...
                                contractStyle === 'od_terminal' && "border-b border-slate-800 pb-6 ",
                        ...
                        {['od_swiss', 'od_brutal', 'od_editorial', 'od_mono', 'od_receipt', 'od_architect', 'od_academic', 'od_gallery', 'od_terminal', 'od_neo_classic'].includes(contractStyle) ? (
                            ...
                            <div className={cn(
                                ...
                                contractStyle === 'od_mono' && "border-t border-white pt-8 ",
                                ...
                                contractStyle === 'od_terminal' && "border-t border-slate-800 pt-8 ",
                        ...
                        <div className={cn(
                            ...
                            <section className="mb-8 break-inside-avoid">
                                <h3 className={cn(
                                    ...
                                    contractStyle === 'od_brutal' && "text-2xl font-black mb-6 bg-white text-black px-3 py-1 inline-flex print:border  ",
                                    ...
                                    contractStyle === 'od_terminal' && "text-xl font-mono mb-4 border-b border-slate-800  pb-2",
