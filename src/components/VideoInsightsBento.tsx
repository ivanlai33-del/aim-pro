            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-slate-800">
                <div>
                    ...
                    <p className="text-xs text-slate-400 mt-1">
                        專案標的：<span className="text-slate-200 font-medium">{projectName}</span> | 整合 NeMo 視覺大模型、Whisper 字幕轉譯與 NV-Embed 語意檢索
                    </p>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-2">
                    <div className="flex items-center gap-1.5 bg-slate-900 px-3 py-1.5 rounded-xl border border-slate-800 text-[11px]">
                        ...
                        <span>NV-Embed-QA: <strong className="text-cyan-400">100%</strong></span>
                    </div>
                    <div className="flex items-center gap-1.5 bg-slate-900 px-3 py-1.5 rounded-xl border border-slate-800 text-[11px]">
                        <Database className="w-3.5 h-3.5 text-purple-400" />
                        <span>Milvus Index: <strong className="text-purple-400">Active</strong></span>
                    </div>
                    <div className="flex items-center gap-1.5 bg-slate-900 px-3 py-1.5 rounded-xl border border-slate-800 text-[11px]">
                        <Layers className="w-3.5 h-3.5 text-emerald-400" />
                        <span>Whisper-v3: <strong className="text-emerald-400">0.4s 延遲</strong></span>
                    </div>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-slate-900/80 p-4 rounded-2xl border border-slate-800 space-y-1">
                            ...
                            <div className="text-2xl font-black text-white flex items-baseline gap-1">
                                94<span className="text-xs text-slate-400 font-normal">/100 分</span>
                            </div>
                        ...
                        <div className="bg-slate-900/80 p-4 rounded-2xl border border-slate-800 space-y-1">
                            ...
                            <div className="text-2xl font-black text-cyan-400 flex items-baseline gap-1">
                                14.5<span className="text-xs text-slate-400 font-normal">小時</span>
                            </div>
                ...
                <div className="lg:col-span-7 flex flex-col bg-slate-900/40 rounded-2xl border border-slate-800 overflow-hidden">
                    ...
                    <div className="flex items-center border-b border-slate-800 bg-slate-900/80 px-4 pt-2 gap-2">
                        ...
                        >
                            ...
                            AI 關鍵影格與時間軸快篩 ({DEFAULT_TIMESTAMPS.length})
                        </button>
                        <button
