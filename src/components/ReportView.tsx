...
export default function ReportView({ reportContent, onSave, apiKey }: ReportViewProps) {
    ...
    return (
        ...
        <div className="space-y-6 min-h-full flex flex-col">
            <div className="flex justify-between items-center bg-surface p-4 rounded-lg shadow-sm border border-border dark:border-white/5">
            ...
            {isEditing ? (
                <div className="flex-1 flex flex-col space-y-4 min-h-0">
                    <div className="flex-1 bg-surface rounded-xl shadow border border-border dark:border-white/5 overflow-hidden relative group">
                        <textarea
                            ref={textareaRef}
                            value={editedContent}
                ...
                >
                    ...
                    <div className="border-b border-border dark:border-white/5 pb-6 mb-8 flex justify-between items-end">
                        ...
                        components={{
                            table: ({ node, ...props }) => (
                                <div className="overflow-x-auto my-6">
                                    <table className="min-w-full divide-y divide-border dark:divide-white/5 border border-border dark:border-white/5" {...props} />
                                </div>
                            ),
                            thead: ({ node, ...props }) => <thead className="bg-muted" {...props} />,
                            th: ({ node, ...props }) => <th className="px-6 py-3 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider border-b bg-muted border-border dark:border-white/5" {...props} />,
                            td: ({ node, ...props }) => <td className="px-6 py-4 text-sm text-foreground border-b border-border dark:border-white/5 align-top" {...props} />,
                    ...
                    <div className="border-t border-border dark:border-white/5 pt-6 mt-12 text-center text-muted-foreground text-xs">
